...
In this vignette, we will use a modified version of the `mtcars` famous dataset, which comprises 11 aspects of design and performance for 32 automobiles. Let's modify it to add textual categories, keep ronames as a column, make some numeric variables factors, and add labels from a table using `import_labels()`. 
