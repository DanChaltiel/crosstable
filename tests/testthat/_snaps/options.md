# All options work
    ...
    Output
      ...
      1         cyl      Number of cylinders               4                                                    7 (87.50%)                                                    1 (12.50%)                                                             2 Odds ratio [95% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [2.3e-200 to NA] p value: 0.0001 \n(Fisher's Exact Test for Count Data)
      2         cyl      Number of cylinders               6                                                        0 (0%)                                                      1 (100%)                                                             3 Odds ratio [95% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [2.3e-200 to NA] p value: 0.0001 \n(Fisher's Exact Test for Count Data)
      3         cyl      Number of cylinders               8                                                        0 (0%)                                                     11 (100%)                                                             2 Odds ratio [95% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [2.3e-200 to NA] p value: 0.0001 \n(Fisher's Exact Test for Count Data)
    ...
    Output
      ...
      1         cyl        cyl                            4         7 (87.5%, 100%)       1 (12.5%, 7.7%)                     2            10 (37.0%) Odds ratio [70% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [1.3e-79 to 2.7e+247] p value: <0.1 \n(Fisher's Exact Test for Count Data)
...
---
    ...
    Output
      ...
      'data.frame':	11 obs. of  9 variables:
       ...
       $ NA      : chr  "2" "3" "2" "1" ...
       $ Total   : chr  "10 (37.0%)" "4 (14.8%)" "13 (48.1%)" "5" ...
       $ effect  : 'glue' chr  "Odds ratio [70% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [1.3e-79 to 2.7e+247]" "Odds ratio [70% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [1.3e-79 to 2.7e+247]" "Odds ratio [70% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [1.3e-79 to 2.7e+247]" "Odds ratio [70% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [1.3e-79 to 2.7e+247]" ...
    ...
    Output
      ...
      'data.frame':	15 obs. of  8 variables:
       ...
       $ NA      : chr  NA "2" "3" "2" ...
       $ Total   : chr  NA "10 (37.0%)" "4 (14.8%)" "13 (48.1%)" ...
       $ effect  : 'glue' chr  "Odds ratio [70% Wald CI], ref='vshaped vs straight'\n6 vs 4: 6.0e+09 [0 to NA]\n8 vs 4: 6.0e+09 [1.3e-79 to 2.7e+247]" NA NA NA ...
       $ test    : chr  "p value: <0.1 " NA NA NA ...
       - attr(*, "debug")=List of 3
        ..$ interface: chr "quosure"
        ..$ x_class  : Named chr [1:4] "factor" "numeric" "POSIXct, POSIXt" "Surv"
        .. ..- attr(*, "names")= chr [1:4] "cyl" "carb" "qsec_posix" "surv"
